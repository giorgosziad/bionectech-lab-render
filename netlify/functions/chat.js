...
async function handleChat(event, user) {
  ...
  // the static doctrine block and from not forcing max-effort thinking on every turn â€” never from
  ...
  const _ingredients = (b.smart && _smartHard)
    ...
    : '';
  // SPEED â€” PROMPT CACHING SPLIT: the persona doctrine (buildBriefing) is large (6-8k tokens) and is
  ...
  // re-processed the entire doctrine on nearly every message â€” the real source of the delay.
  ...
  for (let ci = 0; ci < candidates.length; ci++) {
    ...
    // â”€â”€ BIONECTECH MCP CONNECTORS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // flagship) and we ended up on a different one, say WHY â€” never swap models silently.
  var _modelNote = null;
