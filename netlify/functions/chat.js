...
function buildBriefing(ownerVerified, persona) {
  const lines = (persona === 'nicolle' ? NICOLLE_BASE : persona === 'karim' ? KARIM_BASE : persona === 'giorgos' ? GIORGOS_BASE : persona === 'galen' ? GALEN_BASE : persona === 'elias' ? ELIAS_BASE : persona === 'kostas' ? KOSTAS_BASE : persona === 'elena' ? ELENA_BASE : persona === 'solon' ? SOLON_BASE : KARAM_BASE).slice();
