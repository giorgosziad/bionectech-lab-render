...
const lines = (persona === 'nicolle' ? NICOLLE_BASE : persona === 'karim' ? KARIM_BASE : persona === 'giorgos' ? GIORGOS_BASE : persona === 'galen' ? GALEN_BASE : persona === 'elias' ? ELIAS_BASE : persona === 'kostas' ? KOSTAS_BASE : persona === 'elena' ? ELENA_BASE : persona === 'solon' ? SOLON_BASE : persona === 'nour' ? NOUR_BASE : KARAM_BASE).slice();
  ...
  const NAME = (persona === 'nicolle') ? 'Nicolle' : (persona === 'karim') ? 'Karim' : (persona === 'giorgos') ? 'Giorgos' : (persona === 'galen') ? 'Galen' : (persona === 'elias') ? 'Elias' : (persona === 'kostas') ? 'Kostas' : (persona === 'elena') ? 'Elena' : (persona === 'solon') ? 'Solon' : (persona === 'nour') ? 'Nour' : 'Karam';
...
const PERSONA_NAMES = { karam:'Karam', nicolle:'Nicolle', karim:'Karim', giorgos:'Giorgos', galen:'Galen', hakim:'Galen', elias:'Elias', kostas:'Kostas', elena:'Elena', solon:'Solon', nour:'Nour' };
...
async function handleChat(event, user, res, onProgress) {
  ...
  const persona = (_pRaw === 'nicolle') ? 'nicolle' : (_pRaw === 'karim') ? 'karim' : (_pRaw === 'giorgos') ? 'giorgos' : (_pRaw === 'galen') ? 'galen' : (_pRaw === 'elias') ? 'elias' : (_pRaw === 'kostas') ? 'kostas' : (_pRaw === 'elena') ? 'elena' : (_pRaw === 'solon') ? 'solon' : (_pRaw === 'nour') ? 'nour' : 'karam';
  ...
  const _pName = (persona === 'nicolle') ? 'Nicolle' : (persona === 'karim') ? 'Karim'
               ...
               : (persona === 'elena') ? 'Elena' : (persona === 'solon') ? 'Solon' : (persona === 'nour') ? 'Nour' : 'Karam';
